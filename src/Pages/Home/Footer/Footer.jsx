    ...
    return (
        <div className="footer-bg">
                ...
                <Row className="text-white">
                    ...
                    <Col xs={6} md={3}>
                        <div className="single-footer-widget">
                            ...
                            <div className="widget-content">
                                <NavLink className="footer-link">Cardiology</NavLink>
                                <NavLink className="footer-link">Neurology</NavLink>
                                <NavLink className="footer-link">Orthopedics</NavLink>
                                <NavLink className="footer-link">Dentistry</NavLink>
                                <NavLink className="footer-link">Surgery</NavLink>
                            </div>
                        </div>
                    </Col>
                    <Col xs={6} md={3}>
            ...
            <div className="footer-copy-right text-center text-white">
                <p className='mb-0'>&copy; 2024 - <span className="developer">Joanna Suzan Biju</span> | All Rights Reserved</p>
            </div>
        </div>
    );
};
